...
public class TelaPrincipal {
	...
	private void initialize() {
		...
		comboBoxM.setRenderer(new DistanceRenderer());
		...
		ComboBox_P1.setRenderer(new DistanceRenderer());
		...
		btnConversao.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String ValorAmostra = MetodoUtil.metodoUtil(conversor, destino.getNome());
